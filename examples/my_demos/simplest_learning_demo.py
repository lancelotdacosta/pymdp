...
agent = Agent(A=A_gm, pA=pA, B=B_gm, pB=pB, D=D_gm, pD=pD,  # pass the likelihood, transition, and initial state probability distributions
              ...
              lr_pA=1,lr_pB=1,lr_pD=1,  # mathematically this should always be equal to 1.0
